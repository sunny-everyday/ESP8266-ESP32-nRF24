...
String buf = "";
int len;
int buf8,buf9,buf10,buf11,buf12,bufx;
int id20=200;
int id21=200;
...
// Display the HTML web page
            ...
            // Web Page Heading
            client.println("<body><h3>ALARM  CONTROL</h3>");
       client.println("<div>");    
...
//--------------------------------------------
if(header.indexOf("sleep") >= 0){//休眠

 for(int h=0;h<1;h++){
   uint8_t data[14] ={red,grn,blu,dur*i,itv*j,fois,6,0,0,0,0,22,60,9} ;//buf[13]=9是报警灯休眠命令
nrf24.send(data, sizeof(data));
nrf24.waitPacketSent();
}
data[13]=0;
